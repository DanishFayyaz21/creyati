// src/pages/services/Advertising.jsx
    ...
    <>
      <section className="pt-40 pb-20 bg-black text-white">
        <div className="container mx-auto">
          ...
          {/* Advertising-specific gallery */}
          <div className="grid gap-3 md:gap-6 pt-16">
            ...
            <div>
              <video
                ...
                muted
                playsInline
                className="w-full rounded-lg lg:rounded-[25px] h-[207px] md:h-full object-cover"
            ...
            <div className="grid grid-cols-12 gap-4 lg:gap-8">
              <div className="col-span-12 lg:col-span-5">
                <img
                  ...
                  alt="img-6"
                  className="rounded-lg lg:rounded-[25px] w-full h-[207px] md:h-[415px] object-cover"
                />
              </div>
              ...
              <div className="col-span-12 lg:col-span-7">
                <img
                  ...
                  alt="img-7"
                  className="rounded-lg lg:rounded-[25px] w-full h-[256px] md:h-[415px] object-cover"
                />
              </div>
            </div>
          </div>
          ...
          {/* Service Navigation */}
          <ServiceNavigation currentSlug="advertising" />
        </div>
      </section>
      <ContactUs />
    </>
