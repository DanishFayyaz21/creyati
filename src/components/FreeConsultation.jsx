  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-4 py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Calendar */}
        <div className={[
          "rounded-2xl border border-black bg-white shadow-sm transition-all duration-500 ease-in-out",
          ...
          <div className="p-4">
            ...
            <div className="grid grid-cols-7 gap-2">
              {calendarCells.map((dateObj, idx) => {
                if (!dateObj) {
                  return <div key={idx} className="h-12 rounded-xl bg-transparent" />;
                }
                ...
                return (
                  <button
                    ...
                    disabled={disabled}
                    className={[
                      "py-2.5  rounded-xl border text-sm flex items-center justify-center relative transition",
                      disabled
      ...
      <div className="mt-8 text-xs text-gray-500">
        <div className="font-medium text-gray-700 mb-1">Setup notes</div>
        <ul className="list-disc pl-5 space-y-1">
          <li>
            Install EmailJS: <span className="font-mono">npm i @emailjs/browser</span>
          </li>
          <li>
